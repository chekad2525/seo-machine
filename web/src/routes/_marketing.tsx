...
function getMobileNavItems(githubStarCount: string) {
  return [
    ...
    },
    {
      label: "منابع",
      links: [
        { label: "راه‌اندازی عامل هوشمند", href: "/docs/agent-setup" },
        { label: "مهارت‌ها", href: "/docs/skills" },
        { label: "کتابخانه راهبردها", href: "/library" },
  ...
  const resources = [
    {
      label: "MCP",
      href: "/docs/mcp",
      description: "اتصال OpenSEO به ابزارهای هوش مصنوعی.",
    },
    {
      label: "مهارت‌ها",
      href: "/docs/skills",
      description: "گردش‌کارهای هدفمند OpenSEO.",
    },
    {
      label: "کتابخانه راهبردها",
      href: "/library",
      description: "راهبردهای کاربردی سئو بر اساس موضوع.",
    },
    {
      label: "وبلاگ",
      href: "/blogs",
      description: "مقاله‌ها و راهنماهای سئو.",
    },
    {
      label: "مستندات",
      href: "/docs",
      description: "راهنمای راه‌اندازی، MCP، مهارت‌ها و میزبانی شخصی.",
    },
  ];
            ...
            <div>
              ...
              <div className="mt-3 space-y-2">
                ...
                >
                  ...
                  <span className="mt-0.5 block text-xs leading-relaxed text-neutral-600">
                    اتصال Claude، Codex و دیگر عامل‌ها.
                  </span>
                </a>
                <a
                ...
                >
                  ...
                  <span className="mt-0.5 block text-xs leading-relaxed text-neutral-600">
                    داده‌های سرچ کنسول برای عامل‌ها.
                  </span>
                </a>
                <a
                  href="/features"
                ...
                >
                  مشاهدهٔ همه امکانات <span aria-hidden="true">&larr;</span>
                </a>
              </div>
            </div>
          </div>
    ...
    <>
      ...
      <div className="mt-16 border-t border-[var(--color-border-subtle)] pt-8">
        ...
        <p className="text-sm text-neutral-600 mt-1 leading-relaxed">
          به‌روزرسانی محصول، امکانات جدید و خبرهای پشت‌صحنه.
        </p>
        <div className="mt-3">
          <NewsletterSignup />
        </div>
