...
export const featurePages = {
  keywordResearch: {
    ...
    eyebrow: "تحقیق کلمات کلیدی",
    navDescription: "ایده‌های کلمات کلیدی و نتایج جستجو را پیدا کنید.",
  ...
  siteAudit: {
    ...
    eyebrow: "ممیزی سایت",
    navDescription: "سیگنال‌های سئوی هر صفحه را بررسی کنید.",
  ...
  backlinks: {
    ...
    eyebrow: "بک‌لینک‌ها",
    navDescription: "لینک‌ها و دامنه‌های ارجاع‌دهنده را بررسی کنید.",
  ...
  domainOverview: {
    ...
    eyebrow: "نمای کلی دامنه",
    navDescription: "دیده‌شدن رقبا را تحلیل کنید.",
  ...
  rankTracking: {
    ...
    eyebrow: "ردیابی رتبه",
    navDescription: "جایگاه کلمات کلیدی را پایش کنید.",
  ...
  savedKeywords: {
    ...
    eyebrow: "کلمات ذخیره‌شده",
    navDescription: "فرصت‌های سئو را سازمان‌دهی کنید.",
  ...
  aiBrandVisibility: {
    ...
    eyebrow: "دیده‌شدن در هوش مصنوعی",
    navDescription: "اشاره به برند را در جستجوی هوش مصنوعی پیدا کنید.",
  ...
  aiSearchPrompts: {
    ...
    eyebrow: "کاوشگر پرامپت",
    navDescription: "پاسخ مدل‌های پشتیبانی‌شده را مقایسه کنید.",
...
export const featureGroups = [
  {
    label: "گردش‌کار کلمات کلیدی",
    description: "کلمات مهم را پیدا، سازمان‌دهی و پایش کنید.",
    pages: [
  ...
  {
    label: "تحقیق دامنه",
    description: "رقبا، بک‌لینک‌ها و سلامت فنی را بشناسید.",
    pages: [
  ...
  },
  {
    ...
    description: "پرامپت‌ها، ارجاع‌ها و دیده‌شدن برند را بررسی کنید.",
