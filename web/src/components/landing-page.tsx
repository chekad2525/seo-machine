...
const SIGNUP_URL = appUrl("/sign-up");
    ...
    <section className="itc-hero">
      <Container>
        <a
          ...
          aria-label="رتبهٔ اول محصول روز در Product Hunt"
        >
          <ProductHuntLaurel />
        </a>
        <h1
        ...
        >
          پلتفرم مدرن و متن‌باز سئو
        </h1>
        <p
          className="itc-subhead itc-muted itc-hero-subtitle"
          style={{ maxWidth: 640, margin: "24px auto 0" }}
        >
          بدون دادهٔ باکیفیت، هوش مصنوعی فقط پیشنهادهای کلی می‌دهد. OpenSEO
          کمک می‌کند شما و عامل هوش مصنوعی‌تان با هم روی استراتژی سئو و محتوای
          متناسب با کسب‌وکارتان کار کنید.
        </p>
        <div className="itc-hero-ctas">
          <div className="itc-hero-cta-group">
            <ArrowCta size="lg" />
            <p className="itc-hero-cta-note">بدون نیاز به کارت اعتباری</p>
          </div>
        </div>
      </Container>
    </section>
    ...
    <section className="itc-inverse">
      <Container>
        <div className="itc-testimonials">
          ...
          >
            مورد اعتماد صدها کاربر در سراسر جهان
          </h2>
...
const FEATURE_CARDS = [
  {
    ...
    blurb: "ایده‌ها، حجم جستجو، سختی، نیت کاربر و نتایج زنده را بررسی کنید.",
  },
  {
    page: featurePages.domainOverview,
    blurb: "ترافیک ارگانیک و کلمات کلیدی رتبه‌دار را برآورد کنید.",
  },
  {
    page: featurePages.backlinks,
    blurb: "بک‌لینک‌ها، دامنه‌های ارجاع‌دهنده و کیفیت لینک‌ها را ببینید.",
  },
  {
    page: featurePages.rankTracking,
    blurb: "جایگاه کلمات کلیدی را در گذر زمان پیگیری کنید.",
  },
  {
    page: featurePages.siteAudit,
    blurb: "صفحات را خزش کنید و مشکلات فنی را پیدا کنید.",
  },
  {
    page: featurePages.aiBrandVisibility,
    blurb: "اشاره‌ها، ارجاع‌ها و پرامپت‌های جستجوی هوش مصنوعی را بررسی کنید.",
  },
  {
    page: featurePages.aiSearchPrompts,
    blurb: "پاسخ پرامپت‌ها را در مدل‌های هوش مصنوعی مقایسه کنید.",
  },
  {
    page: featurePages.savedKeywords,
    blurb: "ایده‌ها را برای تولید محتوا و پایش سازمان‌دهی کنید.",
  },
];
...
function DemoVideo() {
  return (
    <video
      ...
      playsInline
      preload="metadata"
      aria-label="نمایش OpenSEO: تحقیق کلمات کلیدی"
    >
      <source src="/demo.mp4" type="video/mp4" />
      <img
        src="/demo-poster.webp"
        alt="داشبورد تحقیق کلمات کلیدی OpenSEO"
        width={1280}
        height={966}
        loading="lazy"
        decoding="async"
    ...
    <section className="itc-section itc-section-demo">
      <Container>
        <div className="itc-narrow">
          <h2 className="itc-display-lg">OpenSEO را در عمل ببینید</h2>
          <p className="itc-subhead itc-muted" style={{ margin: "20px 0 0" }}>
            تحقیق کلمات کلیدی، تحلیل رقبا، بک‌لینک‌ها، ردیابی رتبه، ممیزی فنی
            و دیده‌شدن در جستجوی هوش مصنوعی؛ همگی بر پایهٔ داده‌های واقعی
            DataForSEO و در ارتباط با یکدیگر.
          </p>
        </div>
        ...
        <div className="itc-feature-more-header">
          <a href="/features" className="itc-textlink">
            همهٔ امکانات <IconArrowRight size={15} className="itc-arrow" />
          </a>
        </div>
      </Container>
    </section>
      ...
      <Container>
        <div className="itc-mcp-grid">
          <div>
            ...
            <h2 className="itc-display-lg">با MCP قدرتمندتر شوید</h2>
            <p className="itc-body-lg itc-muted" style={{ margin: "20px 0 0" }}>
              به‌جای حدس، دادهٔ واقعی سئو را در اختیار عامل خود بگذارید.
              عامل می‌تواند کلمات کلیدی، رقبا، بک‌لینک‌ها و عملکرد
              Google Search Console را بررسی کند و شما نتیجه را در OpenSEO ببینید.
            </p>
...
function OpenSourceSection() {
  return (
    <section className="itc-section itc-section-open-source">
      <Container>
        <div className="itc-narrow">
          <h2 className="itc-display-lg">۱۰۰٪ متن‌باز</h2>
          <p className="itc-subhead itc-muted" style={{ margin: "20px 0 0" }}>
            هرکس باید بتواند ابزارهای خود را میزبانی و شخصی‌سازی کند.
            اگر کسی قصد دارد ابزار سئوی خودش را بسازد، می‌تواند OpenSEO را
            نقطهٔ شروع قرار دهد.
          </p>
        </div>
        ...
        >
          ...
          >
            <IconGithub size={16} />
            ستاره‌دادن در GitHub
          </a>
          <a href="/open-source-seo" className="itc-textlink">
            چرا متن‌باز؟ <IconArrowRight size={15} className="itc-arrow" />
          </a>
        </div>
      </Container>
    </section>
        ...
        >
          <div style={{ maxWidth: 420 }}>
            <p style={{ margin: 0, fontSize: 15, fontWeight: 500 }}>
              از خبرها باخبر بمانید
            </p>
            <p className="itc-body-sm itc-muted" style={{ margin: "6px 0 0" }}>
              تازه‌های محصول، امکانات جدید و گاهی نگاهی به پشت صحنه.
            </p>
          </div>
          <div
  ...
  return (
    <div className="itc">
      ...
      <a
        ...
        aria-label="پیوستن به دیسکورد OpenSEO"
      >
        <IconDiscord size={18} />
        <span>Discord</span>
      </a>
