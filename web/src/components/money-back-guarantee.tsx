const REFUND_PROMISE = `Not for you yet? Email ${import.meta.env.VITE_SUPPORT_EMAIL || "seomachine@info.ir"} within 30 days of your charge and we'll refund your subscription.`;
