...
const tabs = [
  { to: "/p/$projectId/settings" as const, label: "عمومی", exact: true },
  { to: "/p/$projectId/settings/integrations" as const, label: "اتصال‌ها" },
];
    ...
    <div className="h-full overflow-auto bg-base-100">
      <div className="mx-auto w-full max-w-2xl space-y-8 p-4 py-8 pb-24 sm:p-6 md:py-12 md:pb-12">
        <div className="space-y-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">تنظیمات پروژه</h1>
