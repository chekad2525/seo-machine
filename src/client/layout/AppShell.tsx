    ...
    <div className="flex h-[100dvh] bg-base-200">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="flex min-h-0 flex-1 flex-col md:pt-2">
          <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-base-100 md:rounded-tr-lg md:border-r md:border-t md:border-base-300">
            <SeoApiStatusBanners
...
function MobileTopBar({
  ...
  return (
    <div className="flex shrink-0 items-center gap-1 border-b border-base-300 bg-base-100 px-2 py-1.5 md:hidden">
      ...
      <Link to="/" className="mr-1 font-semibold text-base-content">
        OpenSEO
      </Link>
    </div>
  );
